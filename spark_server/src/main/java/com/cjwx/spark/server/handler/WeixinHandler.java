...
public class WeixinHandler {
    ...
    @RestMethod("route")
    public String route(HttpServletRequest request, @RequestBody JSONObject param) {
        ...
        try {
            ...
            String encryptType = StringUtils.isEmpty(param.getString("encrypt_type")) ? "raw" : param.getString("encrypt_type");
            if ("raw".equals(encryptType)) {
                ...
                // 是aes加密的消息
                String msgSignature = param.getString("msg_signature");
